...
require.register("web/static/js/foundation.js", function(exports, require, module) {
"use strict";
...
var _new = require('./part/new');

var _new2 = _interopRequireDefault(_new);

var _edit = require('./part/edit');
...
var views = {
  PartNewView: _new2.default,
  PartEditView: _edit2.default
};
...
;require.register("web/static/js/views/part/edit.js", function(exports, require, module) {
'use strict';
...
var PartEditView = function (_MainView) {
  _inherits(PartEditView, _MainView);

  function PartEditView() {
    _classCallCheck(this, PartEditView);

    return _possibleConstructorReturn(this, (PartEditView.__proto__ || Object.getPrototypeOf(PartEditView)).apply(this, arguments));
  }

  _createClass(PartEditView, [{
    key: 'mount',
    value: function mount() {
      _get(PartEditView.prototype.__proto__ || Object.getPrototypeOf(PartEditView.prototype), 'mount', this).call(this);

      var quill = new _quill2.default('#editor');
    ...
    key: 'unmount',
    value: function unmount() {
      _get(PartEditView.prototype.__proto__ || Object.getPrototypeOf(PartEditView.prototype), 'unmount', this).call(this);
...
exports.default = PartEditView;
});

;require.register("web/static/js/views/part/new.js", function(exports, require, module) {
'use strict';
...
var PartNewView = function (_MainView) {
  _inherits(PartNewView, _MainView);

  function PartNewView() {
    _classCallCheck(this, PartNewView);

    return _possibleConstructorReturn(this, (PartNewView.__proto__ || Object.getPrototypeOf(PartNewView)).apply(this, arguments));
  }

  _createClass(PartNewView, [{
    key: 'mount',
    value: function mount() {
      _get(PartNewView.prototype.__proto__ || Object.getPrototypeOf(PartNewView.prototype), 'mount', this).call(this);
    ...
    key: 'unmount',
    value: function unmount() {
      _get(PartNewView.prototype.__proto__ || Object.getPrototypeOf(PartNewView.prototype), 'unmount', this).call(this);
...
exports.default = PartNewView;
});

;require.register("web/static/js/views/quill.js", function(exports, require, module) {
'use strict';
...
var QuillEditor = function () {
  ...
  _createClass(QuillEditor, [{
    key: 'submitter',
    value: function submitter(form_id, field_id) {
